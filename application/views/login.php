        ...
        <div class="col-md-4 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    ...
                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>SIMDALWAS</span></h6>
                </div>
                    ...
                    <div class="card-body pt-0">
                        <form class="form-horizontal" method="POST" action="<?php echo base_url('login') ?>">
                            <fieldset class="form-group floating-label-form-group">
                                ...
                                <input type="text" class="form-control" id="user-name" name="id" placeholder="Your Username">
                            </fieldset>
